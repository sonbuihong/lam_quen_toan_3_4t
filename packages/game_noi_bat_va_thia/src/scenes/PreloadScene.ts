...
export default class PreloadScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image(TextureKeys.S2_Banner, 'assets/images/S1/banner2.png');
        ...
        this.load.image(TextureKeys.Answer5, 'assets/images/S1/ans5.png');
        this.load.image(TextureKeys.Answer6, 'assets/images/S1/ans6.png');
