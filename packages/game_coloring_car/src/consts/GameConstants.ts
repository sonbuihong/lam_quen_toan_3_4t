...
export const GameConstants = {
  ...
  // =========================================
  // MA LOI CHUNG (ERROR CODES) - Dung cho SDK Tracker
  // =========================================
  ERROR_CODES: {
    /** Tre thoat game hoac bam nut Skip khi chua hoan thanh item */
    USER_ABANDONED: "USER_ABANDONED",
    /** Tre lam dung nhung chi sau khi bam Hint qua > 5 lan (danh cho logic BI) */
    HINT_RELIANCE: "HINT_RELIANCE",
    /** SDK crash, asset khong load duoc, loi logic engine */
  ...
  IDLE: {
    ...
    THRESHOLD: 10000,
    /** Số lần Hint tối đa trước khi log HINT_RELIANCE */
    MAX_HINT_COUNT: 5,
  ...
  PAINT: {
    BRUSH_SIZE: 100,
    /** Tỉ lệ tô màu để tính là hoàn thành (0.90 = 90%) 3-4t để 85% */
    WIN_PERCENT: 0.85,
