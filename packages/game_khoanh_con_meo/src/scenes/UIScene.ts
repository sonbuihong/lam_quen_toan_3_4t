...
export default class UIScene extends Phaser.Scene {
    ...
    init(data: { sceneKey: string; levelIndex?: number }) {
    ...
    private createUI() {
        ...
        // Xác định TextureKeys dựa trên LevelIndex
        let bannerKey = this.levelIndex === 1 ? TextureKeys.S2_Banner : TextureKeys.S1_Banner;
    ...
    public updateLevel(levelIndex: number) {
